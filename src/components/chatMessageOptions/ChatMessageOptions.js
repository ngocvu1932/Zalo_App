...
export const ChatMessageOptions = ({navigation, route}) => { 
    ...
    const handleLeaveGroup = async () => { 
        try {
            const response = await axios.put(`/chat/group/out`, {chatId: items._id})
            if (response.errCode === 0){
                toastRef.current.props.style.backgroundColor = 'green';
        ...
        <View style={styles.container}>  
            ...
            <ScrollView style={styles.body}>
                <View style={{alignItems: 'center', backgroundColor: '#FFFFFF'}}>
                        ...
                        : 
                            ...
                            groupChatInfo.groupPhoto === null ?
                                <Pressable onPress={()=> setModalVisible(true)}>
                                    <View style={{height: 100, width: 100, borderRadius: 55, backgroundColor: '#ECEDF1', justifyContent: 'center', alignItems: 'center'}}>
                                        <FontAwesomeIcon color='#A8ADB3' size={50} icon={faUserGroup} />
                                    </View>
                                 
                                    <View style={{height: 28, width: 28, backgroundColor: '#F8F8F8', position: 'absolute', bottom: 0, right: 0, borderRadius: 20, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#FFFFFF' }}>
                                        <FontAwesomeIcon color='#5E5E5E' size={15} icon={faCamera} />
                                    </View>
                                </Pressable>
                            : 
                                <Pressable onPress={()=> setModalVisible(true)}>
                                    <Image source={{uri: groupChatInfo.groupPhoto}} style={{height: 100, width: 100, borderRadius: 50}}></Image>
                    ...
                    <View style={{flex: 1, flexDirection: 'row', marginTop: 20, width: '80%', justifyContent: 'space-between', marginBottom: 15}}>
                        <Pressable style={styles.pressbtnOP}>
                            <View style={styles.iconInPress}>
                                <FontAwesomeIcon color='#505050' size={22} icon={faMagnifyingGlass} />
                            </View>
                        ...
                        {items.type === "PRIVATE_CHAT" ? (
                            ...
                            <Pressable onPress={()=> {navigation.navigate('AddMember', {items: items})}} style={styles.pressbtnOP}>
                                <View style={styles.iconInPress}>
                                    <FontAwesomeIcon color='#505050' size={22} icon={faUserPlus} />
                                </View>
                        ...
                        <Pressable style={styles.pressbtnOP}>
                            <View style={styles.iconInPress}>
                                <FontAwesomeIcon color='#505050' size={22} icon={faWandMagicSparkles} />
                            </View>
                    ...
                    {items.type === "PRIVATE_CHAT" ? 
                        <View>
                            ...
                            <View style={[styles.btnOpts,]}>
                                <FontAwesomeIcon style={{marginLeft: 15}} color='#787D80' size={20} icon={faStar} />
                            ...
                            <Pressable style={styles.btnOpts}>
                                <FontAwesomeIcon style={{marginLeft: 15}} color='#787D80' size={20} icon={faClock} />
                            ...
                            <Pressable style={[styles.btnOpts, {marginTop: 10}]}>
                                <FontAwesomeIcon style={{marginLeft: 15}} color='#787D80' size={20} icon={faThumbtack} />
                            ...
                            <Pressable style={[styles.btnOpts]}>
                                <FontAwesomeIcon style={{marginLeft: 15}} color='#787D80' size={20} icon={faEyeSlash} />
                            ...
                            <Pressable style={[styles.btnOpts]}>
                                <FontAwesomeIcon style={{marginLeft: 15}} color='#787D80' size={20} icon={faPhoneVolume} />
                            ...
                            <Pressable style={[styles.btnOpts]}>
                                <FontAwesomeIcon style={{marginLeft: 15}} color='#787D80' size={20} icon={faUserGear} />
                                <Text style={styles.txt}>Cài đặt cá nhân</Text>
                                <FontAwesomeIcon style={{marginRight: 10}} color='#787D80' size={15} icon={faChevronRight} />
                            </Pressable>

                            <Pressable style={[styles.btnOpts, {marginTop: 10}]}>
                                <FontAwesomeIcon style={{marginLeft: 15}} color='#787D80' size={20} icon={faTriangleExclamation} />
                            ...
                            <Pressable style={[styles.btnOpts]}>
                                <FontAwesomeIcon style={{marginLeft: 15}} color='#787D80' size={20} icon={faCircleXmark} />
                            ...
                            <Pressable style={[styles.btnOpts]}>
                                <FontAwesomeIcon style={{marginLeft: 15}} color='#787D80' size={20} icon={faTrashCan} />
                    ...
                    : items.type === "GROUP_CHAT" ? 
                        <View>
                            <Pressable style={[styles.btnOpts, {justifyContent: 'space-between'}]}>
                                ...
                                <FontAwesomeIcon size={15} style={{marginRight: 10}} icon={faChevronRight} />
                            </Pressable>
                            ...
                            <Pressable style={[styles.btnOpts, {justifyContent: 'space-between'}]}>
                                <FontAwesomeIcon style={{marginLeft: 15}} color='#787D80' size={20} icon={faChartSimple} />
                                <Text style={styles.txt}>Bình chọn</Text>
                                <FontAwesomeIcon size={15} style={{marginRight: 10}} icon={faChevronRight} />
                            </Pressable>

                            {groupChatInfo.administrator === user.id ? 
                                <Pressable style={[styles.btnOpts, {justifyContent: 'space-between', marginTop: 10}]}>
                                    <FontAwesomeIcon style={{marginLeft: 15}} color='#787D80' size={20} icon={faGear} />
                                    <Text style={styles.txt}>Cài đặt nhóm</Text>
                                    <FontAwesomeIcon size={15} style={{marginRight: 10}} icon={faChevronRight} />
                                </Pressable> : 
                            ''}

                            <Pressable style={[styles.btnOpts, {justifyContent: 'space-between', marginTop: 10}]} onPress={()=> navigation.navigate('ManagerGroupMembers', {items: items})}>
                                <FontAwesomeIcon style={{marginLeft: 15}} color='#787D80' size={20} icon={faUsers} />
                                <Text style={styles.txt}>Xem thành viên {`(${groupChatInfo.participants?.length})`}</Text>
                                <FontAwesomeIcon size={15} style={{marginRight: 10}} icon={faChevronRight} />
                            </Pressable>
                            ...
                            <Pressable style={[styles.btnOpts, {justifyContent: 'space-between'}]}>
                                <FontAwesomeIcon style={{marginLeft: 15}} color='#787D80' size={20} icon={faUserCheck} />
                            ...
                            <Pressable style={[styles.btnOpts, {justifyContent: 'space-between'}]}>
                                <FontAwesomeIcon style={{marginLeft: 15}} color='#787D80' size={20} icon={faLink} />
                            ...
                            {groupChatInfo.administrator === user.id ? 
                                <Pressable style={[styles.btnOpts, {justifyContent: 'space-between'}]} onPress={()=> navigation.navigate('ChangeAdminGroup')}>
                                    <FontAwesomeIcon style={{marginLeft: 15}} color='#787D80' size={20} icon={faUserGear} />
                            ...
                            <Pressable style={[styles.btnOpts, {justifyContent: 'space-between'}]} onPress={ ()=> handleLeaveGroup()}>
                                <FontAwesomeIcon style={{marginLeft: 15}} color='#ED1C24' size={20} icon={faArrowRightFromBracket} />
                            ...
                            {groupChatInfo.administrator === user.id ? 
                                <Pressable style={[styles.btnOpts, {justifyContent: 'space-between'}]} onPress={ ()=> handleDissolveGroup()}>
                                    <FontAwesomeIcon style={{marginLeft: 15}} color='#ED1C24' size={20} icon={faUserGear} />
                                    <Text style={[styles.txt, {color: '#ED1C24'}]}>Giải tán nhóm</Text>
                                </Pressable> : 
                            ''}
                        </View>
                    : ''}
            ...
            {modalVisible ? 
                ...
                >
                    <Pressable style={{flex: 1, backgroundColor: 'rgba(0, 0, 0, 0.3)', alignItems: 'center', justifyContent: 'center'}} onPress={()=> setModalVisible(false)}>
                        <Pressable style={{height: 370, width: 350, backgroundColor: '#FFFFFF', borderRadius: 20}}>
                            <View style={{alignItems: 'center', marginTop: 15}}>
                                {groupChatInfo.groupPhoto === null ?
                                    <View style={{height: 200, width: 200}}>
                                        <View style={{height: 200, width: 200, borderRadius: 100, backgroundColor: '#ECEDF1', justifyContent: 'center', alignItems: 'center'}}>
                                            <FontAwesomeIcon color='#A8ADB3' size={50} icon={faUserGroup} />
                                        </View>
                                    </View>
                                : 
                                    <View style={{height: 200, width: 200}}>
                                        <Image source={{uri: groupChatInfo.groupPhoto}} style={{height: 200, width: 200, borderRadius: 100}}></Image>
                                    </View>
                                }    
                            </View>

                            <View style={{marginTop: 5}}>
                                <Text numberOfLines={1} style={{fontSize: 18, fontWeight: '500', textAlign: 'center'}}>Bạn muốn đổi ảnh nhóm?</Text>
                            </View>

                            <Pressable style={{flexDirection: 'row', height: 50, alignItems: 'center', marginTop: 10}} onPress={()=> openImagePicker('C')}>
                                <FontAwesomeIcon style={{marginLeft: 15}} icon={faCamera} color='#707070' size={20} />
                                <Text style={{fontSize: 17, marginLeft: 10}}>Chụp ảnh</Text>
                            </Pressable>

                            {renderLine(1)}

                            <Pressable style={{flexDirection: 'row', height: 50, alignItems: 'center'}} onPress={()=> openImagePicker('L')}>
                                <FontAwesomeIcon style={{marginLeft: 15}} icon={faImages} size={20} color='#707070' />
                                <Text style={{fontSize: 17, marginLeft: 10}}>Chọn ảnh trên máy</Text>
                            </Pressable>
                        </Pressable>
                    </Pressable>
                </Modal>
